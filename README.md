...
1. Cleaned and joined the 4 CSVs into a single funnel-stage dataset (Lead → Quote → Order)
2. Built calculated measures in Power BI (DAX) for stage-wise conversion rates, revenue by partner, and lead source mix
3. Designed a multi-page dashboard: funnel overview, partner/revenue performance, lead source breakdown, geographic distribution, and monthly revenue trend
